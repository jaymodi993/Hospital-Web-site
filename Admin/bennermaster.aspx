<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Site1.Master" CodeBehind="bennermaster.aspx.vb" Inherits="myweb.bennermaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Banner Master</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Banner Name</label>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="text1" runat="server" class="form-control" ValidationGroup="banner"></asp:TextBox>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter bannar name" BackColor="Red" Display="Dynamic" ForeColor="White" SetFocusOnError="True" ToolTip="Enter banner name" ControlToValidate="text1" ValidationGroup="banner"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="uplode Banner" BackColor="Red" Display="Dynamic" ForeColor="White" SetFocusOnError="True" ToolTip="uplode pic" ControlToValidate="FileUpload1" ValidationGroup="banner"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:HospitalConnectionString %>' DeleteCommand="DELETE FROM [banner_master] WHERE [id] = @id" InsertCommand="INSERT INTO [banner_master] ([b_name], [b_desc], [b_image]) VALUES (@b_name, @b_desc, @b_image)" SelectCommand="SELECT * FROM [banner_master]" UpdateCommand="UPDATE [banner_master] SET [b_name] = @b_name, [b_desc] = @b_desc, [b_image] = @b_image WHERE [id] = @id">
                            <DeleteParameters>
