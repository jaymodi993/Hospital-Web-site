<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Site1.Master" CodeBehind="sev_master.aspx.vb" Inherits="myweb.sev_master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Services Master</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Services name" BackColor="Red" Display="Dynamic" ForeColor="White" SetFocusOnError="True" ToolTip="Enter banner name" ControlToValidate="text1" ValidationGroup="banner"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="uplode Services" BackColor="Red" Display="Dynamic" ForeColor="White" SetFocusOnError="True" ToolTip="uplode pic" ControlToValidate="FileUpload1" ValidationGroup="banner"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="add Services Discrepcon" BackColor="Red" Display="Dynamic" ForeColor="White" SetFocusOnError="True" ToolTip="add Discrepcon" ControlToValidate="TextArea1" ValidationGroup="banner"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <asp:GridView ID="GridView1" CssClass="table table-border table-striped custom-table datatable mb-0 dataTable no-footer" Style="text-align: center; background-color: white" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="b_name" HeaderText="Services" SortExpression="b_name"></asp:BoundField>
                        ...
                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:HospitalConnectionString %>' DeleteCommand="DELETE FROM [sev_master] WHERE [id] = @id" InsertCommand="INSERT INTO [sev_master] ([b_name], [b_desc], [b_image]) VALUES (@b_name, @b_desc, @b_image)" SelectCommand="SELECT * FROM [sev_master]" UpdateCommand="UPDATE [sev_master] SET [b_name] = @b_name, [b_desc] = @b_desc, [b_image] = @b_image WHERE [id] = @id">
                            <DeleteParameters>
